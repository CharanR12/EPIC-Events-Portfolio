      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-navbar items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button onClick={() => scrollToSection('home')} className="text-text/80 hover:text-text transition-colors">Home</button>
            <button onClick={() => scrollToSection('games')} className="text-text/80 hover:text-text transition-colors">Games</button>
            <button onClick={() => scrollToSection('gallery')} className="text-text/80 hover:text-text transition-colors">Gallery</button>
            <button 
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute w-full left-0 top-navbar">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 glass-effect shadow-lg rounded-b-lg">
              <button onClick={() => scrollToSection('home')} className="block w-full text-left px-3 py-2 text-text/80 hover:bg-secondary/10 rounded-md">Home</button>
              <button onClick={() => scrollToSection('games')} className="block w-full text-left px-3 py-2 text-text/80 hover:bg-secondary/10 rounded-md">Games</button>
              <button onClick={() => scrollToSection('gallery')} className="block w-full text-left px-3 py-2 text-text/80 hover:bg-secondary/10 rounded-md">Gallery</button>
